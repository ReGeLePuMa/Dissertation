...
\begin{itemize}
    ...
    \item \textbf{--max\_limit}: How many times should the binary search procedure be run for
    ...
    \item \textbf{--strace\_path}: The path to a statically-linked strace binary
    \item \textbf{--binary\_search}: Decide whether to continue the minimization process with a binary search if dynamic analysis failed
\end{itemize}
